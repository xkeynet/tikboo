...
// =========================================================
// === initFirst — POOL ENGINE VERZE (bez setLayerContent) ===
// =========================================================
function initFirst() {
state.isMuted = true;
syncSoundUI();
...
```
// Pool engine spravuje loading sám — pouze nastavíme src a spustíme
// NIKDY nevoláme setLayerContent() zde → ta by destruovala video element
const v = refs.videoCurrent;
v.muted = true;
v.style.display = 'block';
v.src = PLAYLIST[state.index].src;
v.load();
